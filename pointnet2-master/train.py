...
parser.add_argument('--log_dir', default='log_second', help='Log dir [default: log]')
parser.add_argument('--num_point', type=int, default=1024, help='Point Number [default: 1024]')
parser.add_argument('--max_epoch', type=int, default=51, help='Epoch to run [default: 251]')
...
NUM_CLASSES = 40 # Chao Tang: this may change if we use a larger training set 
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            ...
            # Get model and loss 
            pred,l3_xyz,end_points = MODEL.get_model(pointclouds_pl, is_training_pl, bn_decay=bn_decay)
