...
def get_model(point_cloud, is_training, bn_decay=None):
    ...
    # 略微更改一下,add one more layer or can modify the layer like the following to get the global feature 
    end_points['l3_points'] = l3_points ## 这个就是当前pointcloud的全局特征
    ...
    # 尝试多返还一个变量给get model---这个方法可以使得网络查看中间的几个tensor，算是最基本的办法，也可以
    # 但是定义成函数的花，就必须在tensor之后把名字作为return
    # 据说有另外一种方法可以设置print，根据is_training 的bool来进行输出，可以在之后研究研究
