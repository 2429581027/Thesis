...
parser.add_argument('--log_dir', default='log_part_withoutNorm', help='Log dir [default: log]')
...
def get_batch(dataset, idxs, start_idx, end_idx):### without normal
    ...
    for i in range(bsize):
        ...
        batch_data[i,:,0:3] = ps
        batch_data[i,:,3:6] = np.zeros((normal.shape))# origin:normal
        batch_label[i,:] = seg
